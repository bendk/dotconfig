...
map.map('n', '<leader>dd', '<cmd>Telescope git_diff diff layout_strategy=horizontal<cr>')
map.map('n', '<leader>dh', '<cmd>Telescope git_diff head layout_strategy=horizontal<cr>')
map.map('n', '<leader>dc', '<cmd>Telescope git_diff cached layout_strategy=horizontal<cr>')
